...
//     }; \
    ...
    &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          U_NA,              U_WH_D,            &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         \
    ...
    &kp LPAR,          &kp LBKT,          &kp RBKT,          &kp RPAR,          &kp LS(LA(NUM_2)), &key_repeat,       &gmt LGUI MINUS,   &gmt LALT EQL,     &gmt LCTRL J,   &gmt LSHFT SEMI,   \
